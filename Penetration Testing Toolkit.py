...
class App(tk.Tk):
    ...
    def gui_encrypt_folder(self):
        ...
        if not folder:
            return
        results = process_folder_encrypt(folder, password, out_folder=folder, overwrite=False)
    ...
    def gui_decrypt_folder(self):
        ...
        if not folder:
            return
        results = process_folder_decrypt(folder, password, out_folder=folder, overwrite=False)
